                        ...
                        <div className="md:w-[661px]">
                            ...
                            <div className={"overflow-hidden "}>
                                <AnimateCon refProp={ref}
                                    variants={{
                                        hidden: { top: "30px", opacity: 0 },
                                        visible: { top: "0px", opacity: 1, transition: { duration: 0.8, delay: 0.4 } },
                                    }}
                            ...
                            >
                                <div className="flex justify-center">
                                    <motion.button
                                        className="w-[140px] sm:w-[151px] sm:text-[18px] leading-[22px] font-alexandria h-[50px] bg-[#3A9DFF] rounded-[40px] flex items-center justify-center"
                                    >
                                        Get Started
                                    </motion.button>
                                </div>
                                <div>
                                    <motion.button
                                        className="sm:w-[190px] w-[178px]  text-[#E5E5E5] sm:text-[18px] leading-[22px] font-alexandria h-[50px] border-[1px] border-[grey] rounded-[40px] flex items-center justify-center"
                                    >
