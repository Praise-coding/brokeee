...
export default function FutureBreakdown() {
    return (
        <div className='mx-[20px] flex justify-center relative py-[40px] sm:py-[80px]'>
            ...
            <div className='w-[606px] left-[-101px] sm:left-auto h-[425px] bg-[rgba(74,90,236,0.06)] blur-[139.9px] absolute top-[76px] sm:top-[116px]'>
            ...
            <div className='max-w-[1200px] w-full'>
                <div>
                    ...
                    <div className='text-center'>
                        <div className='font-alexandria text-[28px] sm:text-[48px] text-[#E5E5E5] mt-[16px] sm:mt-[20px] leading-[100%]'>
                            Future Breakdown
                        </div>

                        <div className='text-[16px] sm:text-[18px] justify-self-center leading-[20px] sm:leading-[140%] mt-[16px] sm:mt-[20px] text-[#999999] font-alexandria sm:font-inter max-w-[644px]'>
