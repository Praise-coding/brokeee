...
export default function FutureBlockChain() {
    ...
    const data = [{
        ...
        info: "Connectivity and Ubiquity. The focal points of Web 3.0 emphasize connectivity and ubiquity, ensuring seamless interactions between users and devices within"
    }, {
        title: "Blockchain and decentralization",
        info: "Most important of all, the assurance of blockchain and decentralization helps in encouraging communication between software and browser plugins."
    }, {
        title: "Secure Transaction",
        info: "Ensuring every transaction is protected with cutting-edge security, giving you the confidence to exchange, invest, and grow in a safe and trusted environment."
    }]
    return (
                    ...
                    <div className='text-center'>
                        ...
                        <AnimateCon
                            ...
                            <div
                                ...
                                secures, and transacts, bringing a new era of decentralized technology.
                            </div>
                        </AnimateCon>
                            ...
                            return (
                                <AnimateCon refProp={ref} key={key} variants={{
                                    ...
                                    <div className=''>
                                        ...
                                        <div
                                            className='font-alexandria leading-[20px] text-[14px] sm:text-[16px] text-[#999999] mt-[8px]'>
                                            {data.info}
                                        </div>
                                    </div>
