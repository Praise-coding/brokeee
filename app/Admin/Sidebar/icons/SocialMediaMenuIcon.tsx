...
const SocialMediaMenuIcon = ({isPath}: { isPath: boolean | undefined }) => {
    return (
        <div>
            <svg width="22" height="22" viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
...
export default SocialMediaMenuIcon;